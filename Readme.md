...
Initially, the problem allowed inputs via **JSON or XML**, but the implementation extends this by generating the knowledge graph dynamically using an **LLM backend**.
